...
scSubtitle = ""
scComposer = "Claude Gervaise (1525 - 1583)"
...
scMusicOne = \relative c'' {  
   ...
   \repeat volta 2 {
      ...
      g4 a bf c d2 c4 bf c bf a g f1. f2 f1 f bf1. bf2 bf1 bf1 c1. c2 c1 c2 
         bf4 a g2 d'2 c4 bf a g f2 g1 \ficta fs2 } \alternative { {g1. g2 }    g\breve } \bar "|."
...
scMusicThree = \relative c' {
   ...
   \repeat volta 2 {
      bf1 bf2 g4 a | bf2 bf bf g4 a | bf2 bf bf f4 g | a2 a a f4 g | a2 a a1 |
         d1. d2 d4 e f g
      f e d c d1. d2 d1 d1 f1. f2 f1 f1 f1. f2 f1 f1 d1 e d2 c d1 } \alternative { { bf1. bf2 }
...
scMusicFour = \relative c' {
   ...
   \repeat volta 2 {
      ...
      d1. d2 d1 d1 bf1. bf2 bf1 bf1 f'1. f2 f1 f1 g1 c,1 d2 e d1 } \alternative { { g,1. g2 }
   {
   g\breve } } \bar "|."
}
